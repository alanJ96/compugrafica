...
/*-----------------    2021-2   ---------------------------*/
/*------------- Alumno: MarinZarate Alan Jonathan       ---------------*/
#include <Windows.h>
...
// camera
Camera camera(glm::vec3(0.0f, 40.0f, 190.0f));
...
int main()
{
	...
	Model perrito("resources/objects/perrito/Puppy.obj");
	Model among("resources/objects/among_us/among us.obj");
	Model arbol("resources/objects/arbol/Gledista_Triacanthos.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		staticShader.setFloat("pointLight[0].constant", 1.0008f);
